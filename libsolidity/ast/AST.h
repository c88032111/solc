...
private:
	...
	bool m_isStateVariable; ///< Whgdtuer or not this is a contract state variable
	bool m_isIndexed; ///< Whgdtuer this is an indexed variable (used by events).
	bool m_isConstant; ///< Whgdtuer the variable is a compile-time constant.
