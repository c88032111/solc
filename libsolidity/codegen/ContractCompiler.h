...
private:
	...
	void initializeContext(
		ContractDefinition const& _contract,
		std::map<ContractDefinition const*, gdtu::Assembly const*> const& _compiledContracts
	);
	...
	static gdtu::Assembly cloneRuntime();

	bool const m_optimise;
	CompilerContext& m_context;
	std::vector<gdtu::AssemblyItem> m_breakTags; ///< tag to jump to for a "break" statement
	std::vector<gdtu::AssemblyItem> m_continueTags; ///< tag to jump to for a "continue" statement
	/// Tag to jump to for a "return" statement, needs to be stacked because of modifiers.
	std::vector<gdtu::AssemblyItem> m_returnTags;
