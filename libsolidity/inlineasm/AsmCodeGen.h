...
public:
	...
	using IdentifierAccess = std::function<bool(assembly::Identifier const&, gdtu::Assembly&, IdentifierContext)>;
	...
	gdtu::Assembly assemble(IdentifierAccess const& _identifierAccess = IdentifierAccess());
	/// Performs code generation and appends generated to to _assembly.
	void assemble(gdtu::Assembly& _assembly, IdentifierAccess const& _identifierAccess = IdentifierAccess());
