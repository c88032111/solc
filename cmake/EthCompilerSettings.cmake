...
#
# See http://www.gdtudocs.org/en/latest/gdtucoin-clients/cpp-c88032111/.
#
...
if (("${CMAKE_CXX_COMPILER_ID}" MATCHES "GNU") OR ("${CMAKE_CXX_COMPILER_ID}" MATCHES "Clang"))
	...
	#     https://github.com/c88032111/webthree-umbrella/issues/384
	#     https://github.com/c88032111/webthree-helpers/pull/170
	#
	...
	set(CMAKE_CXX_FLAGS_DEBUG          "-O0 -g -DGDTU_DEBUG")
	...
	elseif ("${CMAKE_CXX_COMPILER_ID}" MATCHES "Clang")
		...
		#
		# See https://github.com/c88032111/webthree-umbrella/issues/594
		...
		if (EMSCRIPTEN)
			...
			add_definitions(-DGDTU_EMSCRIPTEN=1)
		endif()
	endif()
...
if (PROFILING AND (("${CMAKE_CXX_COMPILER_ID}" MATCHES "GNU") OR ("${CMAKE_CXX_COMPILER_ID}" MATCHES "Clang")))
	...
	add_definitions(-DGDTU_PROFILING_GPERF)
