...
function(gdtu_show_dependency DEP NAME)
	get_property(DISPLAYED GLOBAL PROPERTY GDTU_${DEP}_DISPLAYED)
	if (NOT DISPLAYED)
		set_property(GLOBAL PROPERTY GDTU_${DEP}_DISPLAYED TRUE)
...
#message(STATUS "CMake Helper Path: ${GDTU_CMAKE_DIR}")
#message(STATUS "CMake Script Path: ${GDTU_SCRIPTS_DIR}")
...
gdtu_show_dependency(Boost boost)
...
function(gdtu_use TARGET REQUIRED)
	if (NOT TARGET ${TARGET})
		message(FATAL_ERROR "gdtu_use called for non existing target ${TARGET}")
	endif()
	...
	foreach(MODULE ${ARGN})
		...
		if (NOT TARGET_APPLIED)
			...
			gdtu_apply(${TARGET} ${REQUIRED} ${MODULE_SUB})
		endif()
	endforeach()
endfunction()
