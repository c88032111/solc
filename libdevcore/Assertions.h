...
#define asserts(A) ::dev::assertAux(A, #A, __LINE__, __FILE__, GDTU_FUNC)
#define assertsEqual(A, B) ::dev::assertEqualAux(A, B, #A, #B, __LINE__, __FILE__, GDTU_FUNC)
...
#define assertThrow(_condition, _ExceptionType, _description) \
	::dev::assertThrowAux<_ExceptionType>(!!(_condition), _description, __LINE__, __FILE__, GDTU_FUNC)
