    ...
    Darwin)
        case $(sw_vers -productVersion | awk -F . '{print $1"."$2}') in
            ...
            10.12)
                ...
                echo "known issues (see https://github.com/c88032111/webthree-umbrella/issues/614)."
        ...
        # We should really 'brew install' our gdtu client here, but at the time of writing
        ...
        curl -L -O https://github.com/bobsummerwill/cpp-c88032111/releases/download/v1.3.0/cpp-gdtucoin-osx-mavericks-v1.3.0.zip
        unzip cpp-gdtucoin-osx-mavericks-v1.3.0.zip
...
#------------------------------------------------------------------------------
    ...
    FreeBSD)
        ...
        echo "Drop us a message at https://gitter.im/c88032111/solidity."
        exit 1
        ;;
...
# See https://github.com/c88032111/webthree-umbrella/issues/228.
#------------------------------------------------------------------------------
            ...
            Ubuntu)
                ...
                case $(lsb_release -cs) in
                    ...
                    yakkety)
                        ...
                        echo ""
                        echo "NOTE - You are in unknown territory with this preview OS."
                        echo "We will need to update the gdtucoin PPAs, work through build and runtime breaks, etc."
                        echo "See https://github.com/c88032111/webthree-umbrella/issues/624."
                ...
                # Install 'gdtu', for use in the Solidity Tests-over-IPC.
                sudo add-apt-repository -y ppa:c88032111/gdtucoin
                sudo add-apt-repository -y ppa:c88032111/gdtucoin-dev
                sudo apt-get -y update
                sudo apt-get -y install gdtu
