...
## and uploads it to the c88032111/gdtucoin-dev ppa.
##
## If an argument is given, it is used as a tag and the resulting package
## is uploaded to the c88032111/gdtucoin ppa.
##
...
if [ "$branch" = develop ]
then
    pparepo=c88032111/gdtucoin-dev
    ppafilesurl=https://launchpad.net/~c88032111/+archive/ubuntu/gdtucoin-dev/+files
else
    pparepo=c88032111/gdtucoin
    ppafilesurl=https://launchpad.net/~c88032111/+archive/ubuntu/c88032111/+files
fi
...
# Fetch source
git clone --recursive https://github.com/c88032111/solidity.git -b "$branch"
mv solidity solc
