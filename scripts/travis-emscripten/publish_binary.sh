...
#
# The results are committed to https://github.com/c88032111/solc-bin.
#
...
git clone --depth 2 git@github.com:c88032111/solc-bin.git
cd solc-bin
git config user.name "travis"
git config user.email "chris@gdtucoin.org"
