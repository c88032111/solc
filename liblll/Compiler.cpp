...
bytes dev::gdtu::compileLLL(string const& _src, bool _opt, vector<string>* _errors)
{
	try
	{
		CompilerState cs;
...
std::string dev::gdtu::compileLLLToAsm(std::string const& _src, bool _opt, std::vector<std::string>* _errors)
{
	try
	{
		CompilerState cs;
...
string dev::gdtu::parseLLL(string const& _src)
{
	sp::utree o;
	try
	{
