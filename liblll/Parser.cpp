...
void dev::gdtu::killBigints(sp::utree const& _this)
{
	switch (_this.which())
	{
...
void dev::gdtu::debugOutAST(ostream& _out, sp::utree const& _this)
{
	switch (_this.which())
	{
...
void dev::gdtu::parseTreeLLL(string const& _s, sp::utree& o_out)
{
	...
	qi::rule<it, bigint()> multiplier = qi::lit("wei")[qi::_val = 1] | qi::lit("szabo")[qi::_val = szabo] | qi::lit("finney")[qi::_val = finney] | qi::lit("gdtuer")[qi::_val = gdtuer];
