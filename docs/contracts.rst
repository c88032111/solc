...
API, this is done as follows::
    ...
    var MyContract_ = web3.gdtu.contract(source);
    MyContract = web3.gdtu.contract(MyContract_.CONTRACT_NAME.info.abiDefinition);
    // deploy new contract
...
Gdtuer (without data).  In such a context, there is usually very little gas available to
...
.. warning::
    Contracts that receive Gdtuer but do not define a fallback function
...
- `Javascript documentation <https://github.com/c88032111/wiki/wiki/JavaScript-API#contract-events>`_
