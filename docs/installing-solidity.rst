...
can try `browser-solidity <https://gdtucoin.github.io/browser-solidity>`_
which does not need any installation. If you want to use it
without connection to the Internet, you can go to
https://github.com/c88032111/browser-solidity/tree/gh-pages and
...
`solc-js repository <https://github.com/c88032111/solc-js>`_.
...
.. code:: bash
    ...
    sudo add-apt-repository ppa:c88032111/gdtucoin
    sudo apt-get update
...
.. code:: bash
    ...
    sudo add-apt-repository ppa:c88032111/gdtucoin
    sudo add-apt-repository ppa:c88032111/gdtucoin-dev
    sudo apt-get update
    sudo apt-get install solc
