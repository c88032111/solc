...
remappings so that e.g. ``github.com/c88032111/dapp-bin/library`` is remapped to
...
``github.com/c88032111/dapp-bin/`` locally to ``/usr/local/dapp-bin``, you can use
...
The `browser-based compiler <https://gdtucoin.github.io/browser-solidity>`_
