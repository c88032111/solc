...
public:
	...
	std::string gdtu_getCode(std::string const& _address, std::string const& _blockNumber);
	std::string gdtu_call(TransactionData const& _td, std::string const& _blockNumber);
	TransactionReceipt gdtu_getTransactionReceipt(std::string const& _transactionHash);
	std::string gdtu_sendTransaction(TransactionData const& _transactionData);
	std::string gdtu_sendTransaction(std::string const& _transaction);
	std::string gdtu_getBalance(std::string const& _address, std::string const& _blockNumber);
	std::string gdtu_getStorageRoot(std::string const& _address, std::string const& _blockNumber);
