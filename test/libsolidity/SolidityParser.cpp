...
BOOST_AUTO_TEST_CASE(function_natspec_documentation)
{
	...
	GDTU_TEST_REQUIRE_NO_THROW(function = functions.at(0), "Failed to retrieve function");
...
BOOST_AUTO_TEST_CASE(multiple_functions_natspec_documentation)
{
	...
	GDTU_TEST_REQUIRE_NO_THROW(function = functions.at(1), "Failed to retrieve function");
	checkFunctionNatspec(function, "This is test function 2");

	GDTU_TEST_REQUIRE_NO_THROW(function = functions.at(2), "Failed to retrieve function");
	BOOST_CHECK_MESSAGE(function->documentation() == nullptr,
						"Should not have gotten natspec comment for functionName3()");

	GDTU_TEST_REQUIRE_NO_THROW(function = functions.at(3), "Failed to retrieve function");
...
BOOST_AUTO_TEST_CASE(literal_constants_with_gdtuer_subdenominations)
{
	char const* text = R"(
		contract c {
			function c ()
...
BOOST_AUTO_TEST_CASE(literal_constants_with_gdtuer_subdenominations_in_expressions)
{
	char const* text = R"(
		contract c {
			function c ()
