...
BOOST_AUTO_TEST_CASE(blockchain)
{
	char const* sourceCode = "contract test {\n"
							 ...
							 "  }\n"
							 "}\n";
	BOOST_CHECK(m_rpc.rpcCall("miner_setGdtuerbase", {"\"0x1212121212121212121212121212121212121212\""}).asBool() == true);
...
BOOST_AUTO_TEST_CASE(send_gdtuer)
{
	char const* sourceCode = "contract test {\n"
...
BOOST_AUTO_TEST_CASE(contracts_as_addresses)
{
	char const* sourceCode = R"(
		contract helper {
			function() payable { } // can receive gdtuer
		}
		contract test {
			helper h;
...
BOOST_AUTO_TEST_CASE(send_zero_gdtuer)
{
	// Sending zero gdtuer to a contract should still invoke the fallback function
...
BOOST_AUTO_TEST_CASE(reject_gdtuer_sent_to_library)
{
	char const* sourceCode = R"(
		library lib {}
		contract c {
...
BOOST_AUTO_TEST_CASE(inline_long_string_return)
{
		...
		contract C { 
			function f() returns (string) {
				return (["somehtingShort", ""][1]);
			}
		}
	)";
	...
	char const* sourceCode = R"(
		contract C {
			modifier tryCircumvent {
				if (false) _; // avoid the function, we should still not accept gdtuer
			}
